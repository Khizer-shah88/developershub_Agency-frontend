...
const integrations = [
  ...
  { name: "Meta Pixel", category: "Attribution" },
  { name: "Notion", category: "Documentation" },
  { name: "Slack", category: "Client Collaboration" },
];
      ...
      <div className="max-w-[1400px] mx-auto px-6 lg:px-12">
        ...
        >
          ...
          <p className="text-xl text-muted-foreground">
            We plug directly into your design, product, marketing, and engineering stack from day one.
          </p>
        </div>
