...
const features = [
  {
    ...
    description: "We define scope, user journeys, and launch priorities so your team builds the right thing first.",
    visual: "deploy",
  },
  {
    number: "02",
    title: "UI/UX Design Systems",
    description: "From wireframes to polished interfaces, we craft conversion-focused design systems your developers can ship quickly.",
    visual: "ai",
  },
  {
    number: "03",
    title: "Full-Stack Development",
    description: "Modern web apps, API architecture, and scalable codebases built for speed, reliability, and long-term growth.",
    visual: "collab",
  },
  {
    number: "04",
    title: "Growth & Optimization",
    description: "Post-launch support, analytics, SEO, and conversion optimization that keep improving business outcomes month after month.",
    visual: "security",
  },
];
